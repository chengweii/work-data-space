...
public class Shell {
	...
	private Shell(SSHInfo sshInfo) throws JSchException {
		jsch = new JSch();
	 ...
	 */
	public static Shell newInstance() throws JSchException {
		SSHInfo sshInfo = new SSHInfo("jkd_web", "jkd_web", "192.168.5.206", 9830);
		return new Shell(sshInfo);
	}
